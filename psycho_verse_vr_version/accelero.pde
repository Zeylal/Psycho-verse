//code de base pour l'utilisation de l'acceleromètre
...
public class AccelerometerManager {
  ...
  private float threshold = 0.2f;  //non utilisé
  private int interval = 1000;  //non utilisé
...
//  }
  ...
  private SensorEventListener sensorEventListener = new SensorEventListener() {
    private long now = 0;  //non utilisé
    private long timeDiff = 0;  //non utilisé
    private long lastUpdate = 0;  //non utilisé
    private long lastShake = 0;  //non utilisé

    private float x = 0;
    private float y = 0;
    private float z = 0;
    private float lastX = 0;  //non utilisé
    private float lastY = 0;  //non utilisé
    private float lastZ = 0;  //non utilisé
    private float force = 0;  //non utilisé
